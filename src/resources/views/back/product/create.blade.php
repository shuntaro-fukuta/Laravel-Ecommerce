...
@section('content')
<div class="logo text-center mt-5">商品登録</div>
<div class="card col-8 mx-auto">
  <div class="card-body">
    <form action="{{ route('back.products.store') }}" method="post" class="text-left">
      @csrf
      ...
      <div class="form-group my-4 col-9 mx-auto form-check">
        ...
        <input type="radio" id="not_published" name="is_published" value="0">
        &nbsp; &nbsp;
        <label class="text-dark font-weight-bold" for="published">公開</label>
        <input type="radio" id="published" name="is_published" value="1" checked>
